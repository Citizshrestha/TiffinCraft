...
function TableHeaders() {
  return (
    <div className="[word-break:break-word] bg-white content-stretch flex font-semibold gap-[16px] items-start leading-[normal] not-italic overflow-clip pb-[16px] relative shrink-0 text-[#9499a6] text-[12px] w-full" data-name="Table Headers">
      <p className="font-['Inter:Semi_Bold','Noto_Sans:SemiBold','Noto_Sans_Math:Regular','Noto_Sans_Symbols:SemiBold','Noto_Sans_Symbols2:Regular',sans-serif] relative shrink-0 w-[40px]">☐</p>
...
function UserRow() {
  return (
    <div className="bg-white content-stretch flex gap-[16px] items-start overflow-clip py-[16px] relative shrink-0 w-full" data-name="User Row 1">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular','Noto_Sans:Regular','Noto_Sans_Math:Regular','Noto_Sans_Symbols:Regular','Noto_Sans_Symbols2:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#9499a6] text-[20px] text-center w-[80px]">⋮</p>
    </div>
  );
}
