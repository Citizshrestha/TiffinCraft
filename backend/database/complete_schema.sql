...
CREATE TABLE IF NOT EXISTS orders (
    ...
    payment_rejection_reason VARCHAR(500) NULL COMMENT 'Why the cook rejected the proof; shown to the customer so they can resubmit',
    payment_rejected_at TIMESTAMP NULL COMMENT 'When cook rejected the payment screenshot',
    payment_proof_attempts INT NOT NULL DEFAULT 0 COMMENT 'How many proofs have been submitted; a rising count is a dispute signal',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
