...
async function resetTestData() {
    ...
    console.log('\x1b[31m%s\x1b[0m', 'WARNING: This will DELETE all subscription, order, payment, and earnings data!');
    console.log('\x1b[33m%s\x1b[0m', '\nThe following will be reset:');
    console.log('  - All subscriptions and subscription plans');
    console.log('  - All orders and payments');
    console.log('  - All commission settlements (earnings)');
    console.log('  - All reviews, favorites, and notifications');
    console.log('  - All chat conversations');
    console.log('  - All cart data');
    
    console.log('\x1b[32m%s\x1b[0m', '\nThe following will be PRESERVED:');
    console.log('  - Users (customers, cooks, admins)');
    console.log('  - Cook profiles');
    console.log('  - Meals\n');

    const confirmation = await question('Are you sure you want to continue? (yes/no): ');

    if (confirmation.toLowerCase() !== 'yes') {
        console.log('\n\x1b[33m%s\x1b[0m', 'Reset cancelled.');
        rl.close();
        process.exit(0);
    }

    console.log('\n\x1b[36m%s\x1b[0m', 'Starting reset...\n');
